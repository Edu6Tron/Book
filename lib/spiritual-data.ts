...
export const temples: Temple[] = [
  {
    id: "alarnath-dev-3-ap",
    name: "Sri Alarnath Dev",
    city: "Puri",
    state: "Odisha",
    tradition: "Listed religious institution",
    address: "At Alarapur, PO/P.S. Brahmagiri, Puri district, Odisha",
    note: "Address transcribed from the public indexed-institutions list.",
    registryStatus: "Indexed institution record",
    authority: "Odisha Hindu Religious Endowments Department",
    jurisdiction: "Puri Zone (Bhubaneswar)",
    registryId: "3-A.P",
    sourceUrl: "https://hinduendowments.odisha.gov.in/list-of-indexed-institutions-zone-wise/",
    lastChecked: "2026-08-12",
  },
  {
    id: "arjuneswar-dev-4-ap",
    name: "Sri Arjuneswar Dev",
    city: "Puri",
    state: "Odisha",
    tradition: "Listed religious institution",
    address: "At Kalikabadi, PO/P.S. Brahmagiri, Puri district, Odisha",
    note: "Address transcribed from the public indexed-institutions list.",
    registryStatus: "Indexed institution record",
    authority: "Odisha Hindu Religious Endowments Department",
    jurisdiction: "Puri Zone (Bhubaneswar)",
  ...
  {
    id: "amruteswar-dev-5-ap",
    name: "Sri Amruteswar Dev",
    city: "Puri",
    state: "Odisha",
    tradition: "Listed religious institution",
    address: "At Singhakuda, PO Algum, Puri district, Odisha",
    note: "Address transcribed from the public indexed-institutions list.",
    registryStatus: "Indexed institution record",
    authority: "Odisha Hindu Religious Endowments Department",
    jurisdiction: "Puri Zone (Bhubaneswar)",
  ...
  {
    id: "ananteswar-dev-17-ap",
    name: "Ananteswar Dev",
    city: "Puri",
    state: "Odisha",
    tradition: "Listed religious institution",
    address: "At Samjaipur, PO Biragobindapur, Puri district, Odisha",
    note: "Address transcribed from the public indexed-institutions list.",
    registryStatus: "Indexed institution record",
    authority: "Odisha Hindu Religious Endowments Department",
    jurisdiction: "Puri Zone (Bhubaneswar)",
  ...
  {
    id: "akhandalmani-temple-67-ap",
    name: "Akhandalmani Temple",
    city: "Puri",
    state: "Odisha",
    tradition: "Listed religious institution",
    address: "At Khanjipur, PO Nayahat (Jogeswarpur), Puri district, Odisha",
    note: "Address transcribed from the public indexed-institutions list.",
    registryStatus: "Indexed institution record",
    authority: "Odisha Hindu Religious Endowments Department",
    jurisdiction: "Puri Zone (Bhubaneswar)",
  ...
  {
    id: "abhaya-barada-mahaveer-76-ap",
    name: "Sri Abhaya Barada Mahaveer",
    city: "Puri",
    state: "Odisha",
    tradition: "Listed religious institution",
    address: "At Panaspada, Brahmagiri, Puri district, Odisha",
    note: "Address transcribed from the public indexed-institutions list.",
    registryStatus: "Indexed institution record",
    authority: "Odisha Hindu Religious Endowments Department",
    jurisdiction: "Puri Zone (Bhubaneswar)",
