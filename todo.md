...
- [ ] Confirm the Kotlin-first repository presentation after GitHub refreshes language statistics.
- [ ] Publish the verified `v1.0.0-rc.1` Android APK and SHA-256 checksum as a GitHub Release.
- [ ] Verify the public release page and direct APK download flow on Android.
