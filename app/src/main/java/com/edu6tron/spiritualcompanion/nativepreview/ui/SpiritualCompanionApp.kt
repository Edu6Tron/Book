  ...
  Box(modifier = Modifier.fillMaxSize()) {
    ...
    when (selectedTab) {
      ...
      NativeTab.AARTIS -> AartiLibraryScreen(
        ...
        aartiAudioByAarti = state.content.aartiAudioByAarti,
        onAssignSelectedMediaToAarti = onAssignSelectedMediaToAarti,
        onClearSelectedMediaForAarti = onClearSelectedMediaForAarti,
