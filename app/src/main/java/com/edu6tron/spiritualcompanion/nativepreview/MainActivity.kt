  ...
  SpiritualCompanionNativeTheme(
    ...
    Surface(
      ...
      SpiritualCompanionApp(
        ...
        onAssignSelectedMediaToAarti = viewModel::assignSelectedMediaToAarti,
        onClearSelectedMediaForAarti = viewModel::clearSelectedMediaForAarti,
        onPlaySelectedMedia = viewModel::playSelectedMedia,
        onToggleSelectedMediaPlayback = viewModel::toggleSelectedMediaPlayback,
        onSeekSelectedMediaTo = viewModel::seekSelectedMediaTo,
        onSeekSelectedMediaBy = viewModel::seekSelectedMediaBy,
        onSavePersonalLyricTiming = viewModel::savePersonalLyricTiming,
        onClearPersonalLyricTiming = viewModel::clearPersonalLyricTiming,
