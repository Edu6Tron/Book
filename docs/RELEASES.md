...
|---|---|---|---|
| [`v1.1.5-rc.8`](https://github.com/Edu6Tron/Book/releases/tag/v1.1.5-rc.8) | Current bounded-discovery device-test candidate | [`spiritual-companion-native-v1.1.5-rc.8-debug.apk`](https://github.com/Edu6Tron/Book/releases/download/v1.1.5-rc.8/spiritual-companion-native-v1.1.5-rc.8-debug.apk) | Native unit tests, Android lint, debug assembly, and independent GitHub Actions validation passed. |
...
> `v1.1.5-rc.8` is an installable **debug** release candidate for device testing. A Play Store-ready signed APK or AAB is deliberately not published until the repository owner configures the protected GitHub Actions signing secrets described in [Release signing](RELEASE_SIGNING.md).
...
```bash
sha256sum -c spiritual-companion-native-v1.1.5-rc.8-debug.apk.sha256
```
